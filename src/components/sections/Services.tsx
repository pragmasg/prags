...
function MetricCard({ symbol, text }: MetricCardProps) {
  return (
    <div className="hidden lg:flex items-center gap-2 px-4 py-2 bg-white/[0.04] border border-white/[0.08] text-xs text-[#999999] shrink-0">
      <span className="text-[#00D4AA] font-mono font-bold">{symbol}</span>
      <span>{text}</span>
    </div>
  );
}
...
function ServiceRow({ number, name, desc, learnMore, href, metric }: ServiceRowProps) {
  return (
    ...
    >
      <div className="border-l-2 border-transparent group-hover:border-[#00D4AA] transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-12 gap-6 py-8 lg:py-10 items-center">
            {/* Number */}
            <div className="col-span-2 lg:col-span-1">
              <span className="text-xs tracking-widest text-[#00D4AA] font-mono">
                {number}
              </span>
            </div>
            ...
            <div className="col-span-10 lg:col-span-3">
              <h3 className="text-2xl lg:text-3xl font-bold text-[#F5F5F5] group-hover:text-[#00D4AA] transition-colors duration-300 leading-tight">
                {name}
              </h3>
            </div>
            ...
            <div className="col-span-12 lg:col-span-3 lg:col-start-9 flex lg:justify-end items-center gap-4">
              ...
              <span className="text-sm text-[#999999] group-hover:text-[#00D4AA] transition-colors whitespace-nowrap">
                {learnMore}
              </span>
            </div>
          </div>
    ...
    <section id="services" className="bg-[#0A0A0A] py-24 lg:py-32">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 mb-16">
          ...
          <p className="text-[#999999] text-base leading-relaxed mt-4 max-w-xl">
            {t('subtitle')}
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-10">
          <p className="text-sm text-[#999999]">
            ...
            <a
              ...
              className="text-[#999999] hover:text-[#00D4AA] transition-colors duration-200 underline underline-offset-4"
            >
              Let&apos;s talk
            </a>
          </p>
