  ...
  return (
    <main className="min-h-screen bg-[#0A0A0A]">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <p className="mt-8 text-lg text-[#999999] max-w-xl leading-relaxed">{t('subtitle')}</p>
      </section>

      {/* How we work */}
      <section className="bg-[#111111] py-24 border-y border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-6">
          <span className="text-xs tracking-widest uppercase text-[#00D4AA]">{t('howLabel')}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06]">
            {workPrinciples.map((item) => (
              <div key={item.title} className="bg-[#111111] p-10">
                ...
                <p className="text-[#999999] leading-relaxed text-sm">{item.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-6">
          <span className="text-xs tracking-widest uppercase text-[#00D4AA]">{t('openLabel')}</span>
          <h2 className="text-3xl font-bold text-[#F5F5F5] mt-6 mb-6">{t('openTitle')}</h2>
          <p className="text-[#999999] max-w-xl leading-relaxed mb-8">{t('openBody')}</p>
          <a
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <span className="text-xs tracking-widest uppercase text-[#00D4AA]">{t('freelanceLabel')}</span>
          ...
          <div className="border border-white/[0.08] p-10 max-w-2xl bg-[#111111]">
            <p className="text-[#999999] leading-relaxed mb-4">{t('freelanceBody1')}</p>
            <p className="text-[#999999] leading-relaxed mb-8">{t('freelanceBody2')}</p>
            <a
