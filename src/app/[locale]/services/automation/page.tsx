      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="border border-white/[0.08] p-8 bg-[#0F0F0F]">
            <p className="text-xs uppercase tracking-widest text-[#888888] mb-8">{t('workflowLabel')}</p>
                  ...
                  >
                    <span
                      className={`text-xs font-semibold font-mono ${
                        isTeal ? 'text-[#F97316]' : 'text-[#BBBBBB]'
                      }`}
                    >
                      {node.label}
                    </span>
                    <span className="text-xs text-[#888888]">{node.desc}</span>
                  </div>
                );
              })}
            </div>
            <p className="text-xs text-[#888888] mt-6">{t('workflowFooter')}</p>
          </div>
        </div>
      </section>
