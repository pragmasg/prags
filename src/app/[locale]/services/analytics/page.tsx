        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="bg-[#0F0F0F] border border-white/[0.08] p-6 font-mono text-xs leading-relaxed">
            <div className="flex items-center gap-2 mb-4 pb-4 border-b border-white/[0.08]">
              ...
              <span className="ml-2 text-[#555555] text-xs">dashboard.pragmas.io</span>
            </div>
            <div className="text-[#00D4AA] mb-3">REVENUE OVERVIEW — Last 30 days</div>
            <div className="text-[#555555] mb-4">
              ...
              <div className="flex justify-between border-b border-white/[0.06] pb-2 mb-2">
                <span>New MRR</span>
                <span className="text-[#00D4AA]">+$12,400  ↑ 18%</span>
              </div>
              <div className="flex justify-between border-b border-white/[0.06] pb-2 mb-2">
            ...
            <div className="text-[#555555] space-y-1 mb-4">
