        ...
        <div className="space-y-12 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="border border-white/[0.08]">
              <div className="grid grid-cols-3 border-b border-white/[0.08] bg-[#111111]">
                <div className="px-5 py-3">
                  <span className="text-xs font-bold uppercase tracking-wider text-[#F5F5F5]">Category</span>
                </div>
                <div className="px-5 py-3 border-l border-white/[0.08]">
                  <span className="text-xs font-bold uppercase tracking-wider text-[#F5F5F5]">Examples</span>
                </div>
                <div className="px-5 py-3 border-l border-white/[0.08]">
                  <span className="text-xs font-bold uppercase tracking-wider text-[#F5F5F5]">Purpose</span>
                </div>
              </div>
              ...
              {cookieRows.map((row, i) => (
                <div
                  key={row.category}
                  className={`grid grid-cols-3 ${i < 2 ? 'border-b border-white/[0.08]' : ''}`}
                >
